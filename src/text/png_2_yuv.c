...
//Convert from RGB to YUYV 4:2:2
int rgb_2_yuyv422(unsigned char *out, unsigned char **row_pointers, int width, int height)
{
...
int rgb_2_yuv422(unsigned char *out, unsigned char **row_pointers, int width, int height)
{
