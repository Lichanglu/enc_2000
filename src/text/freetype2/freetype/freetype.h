...
FT_BEGIN_HEADER
  ...
  /*    instance of the font for a given g_bak_resolution) in a fixed-size font  */
  ...
  /*              represent (for a given vertical g_bak_resolution).             */
  /*                                                                       */
...
#define ft_encoding_apple_roman     FT_ENCODING_APPLE_ROMAN
  ...
  /*    g_bak_resolution and point-size independent data found in a font file.   */
  /*                                                                       */
  /* <Fields>                                                              */
...
#define FT_STYLE_FLAG_BOLD    ( 1 << 1 )
  ...
  /*    g_bak_resolution and pointsize dependent data of a given face.           */
  /*                                                                       */
  /* <Fields>                                                              */
...
#define ft_open_params    FT_OPEN_PARAMS     /* deprecated */
  ...
  /*                                                                       */
  /*    If the horizontal or vertical g_bak_resolution values are zero, a        */
  ...
  /*                       points.                                         */
  /*                                                                       */
  /*    horz_resolution :: The horizontal g_bak_resolution.                      */
  /*                                                                       */
  /*    vert_resolution :: The vertical g_bak_resolution.                        */
  /*                                                                       */
  /* <Return>                                                              */
  /*    FreeType error code.  0 means success.                             */
  /*                                                                       */
