...
/*获得音频编码参数表*/
int WebGetAudioEncodeParam(AudioEncodeParam *info,int channel)
{
	int inlen=sizeof(AudioEncodeParam);
	int outlen = 0,ret = 0;
...
/*设置音频编码参数*/
int WebSetAudioEncodeParam(AudioEncodeParam *ininfo,AudioEncodeParam *outinfo,int channel)
{
	int inlen=sizeof(AudioEncodeParam);
	int outlen = 0,ret = 0;
...
int webSetEncodingFrofile(int status)
{
	...
	int outval = 0;
	int ret;
	ret =appCmdIntParse(MSG_SET_ENCODING_PROFILE,status,inlen,&outval,&outlen);
	return outval;
}
...
int webGetEncodingFrofile(int *status)
{
	...
	int inval = 0;
	int ret;
	ret =appCmdIntParse(MSG_GET_ENCODING_PROFILE,inval,inlen,status,&outlen);
	return ret;
}
...
int webSetScaleMode(int status)
{
	...
	int outval = 0;
	int ret;
	ret =appCmdIntParse(MSG_SET_SCALE_MODE,status,inlen,&outval,&outlen);
	return ret;
}
...
int webGetScaleMode(int *status)
{
	...
	int inval = 0;
	int ret;
	ret =appCmdIntParse(MSG_GET_SCALE_MODE,inval,inlen,status,&outlen);
	return ret;
}
