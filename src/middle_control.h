...
#define ENCODESERVER_1260_PORT   20010
#define SDK_LISTEN_PORT		4000
 
#define ENCODESERVER_PORT ENCODESERVER_1260_PORT
...
#define	MSG_SDI_REVISE_PICTURE				0x1116  //sdi HV值调整
...
#define	MSG_SETCBCR					0X113E  //设置CbCr
#define	MSG_SETSIGNALSDIADJUST					0X1138  //设置CbCr
#define	MSG_GETSIGNALSDIADJUST					0X1139  //设置CbCr
//###########视频编码信息######################
...
#define MSG_GETSCALEINFO  0X1600
#define MSG_SETSCALEINFO	0X1601
...
//MP 
#define MSG_GET_MP_INFO    0X1606
#define MSG_SET_MP_INFO    0X1607
#define MSG_GET_MP_MODE    0X1608
#define MSG_SET_MP_MODE    0X1609
...
#define	MSG_SETSERIALNO					0x112D  //设置串号
...
#define MSG_GET_ENCODING_PROFILE            0x1159
#define MSG_SET_ENCODING_PROFILE            0x115a
#define MSG_SET_SCALE_MODE                  0x115b
#define MSG_GET_SCALE_MODE                  0x115c
...
#define 			SERVER_UPDATE_FAILED 			0xf0a       //升级失败 
...
typedef enum{
	WEB_LOCK_SCALE=1,
	QUAILTY_LOCK_SCALE=2,
	RECODE_LOCK_SCALE=3,
	IP_XML_LOCK_SCALE=4,//级别最高
}LOCK_SCALE_TYPE;
